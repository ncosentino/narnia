...
- **Window Layouts** — visually compose Collection and individual-session windows on a monitor-aware canvas, then launch the complete workspace with one action
...
| `get_session_worktrees` | List a session's Git worktrees and flag branch-override mismatches |
