...
`settings.db` holds everything Narnia itself records: overrides, favorites, session groups, work
collections, settings, recorded terminal windows, storage metadata, scheduled-job catalog
entries, and session-migration history.
