...
public sealed class WindowsLogonAutostartManager : ILogonAutostartManager
{
    ...
    internal static string BuildServerLauncher(
        ...
        $serverUrl = '{{EscapePowerShellLiteral(serverUrl)}}'
        $skipHealthCheck = ${{skipHealthCheck.ToString().ToLowerInvariant()}}
