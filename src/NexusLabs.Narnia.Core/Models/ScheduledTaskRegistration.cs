...
/// <summary>A normalized firing cadence. Weekly uses <see cref="DaysOfWeek"/>; Daily ignores it.</summary>
/// <param name="Kind">Daily or Weekly.</param>
/// <param name="TimeOfDay">Local time of day to fire at.</param>
/// <param name="DaysOfWeek">Days to fire on for a weekly cadence; ignored for daily.</param>
public sealed record ScheduleCadence(
    ScheduleCadenceKind Kind,
    TimeOnly TimeOfDay,
    IReadOnlyList<DayOfWeek> DaysOfWeek)
{
    /// <summary>A short human label (e.g. "Daily 05:00", "Weekly Mon,Fri 05:30").</summary>
