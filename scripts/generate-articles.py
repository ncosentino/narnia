#!/usr/bin/env python3
"""
Generate articles.md from the Dev Leader Narnia tag page.
...
_TAG_URL = 'https://www.devleader.ca/tags/Narnia'


class _ArticleParser(HTMLParser):
    """Parse tagged articles from the devleader.ca tags page."""
...
def fetch_articles(url: str) -> list[dict]:
    """Fetch and parse articles from the Dev Leader tags page."""
...
def generate_markdown(articles: list[dict]) -> str:
    ...
    lines = [
        ...
        "",
        "!!! tip \"Stay Updated\"",
        "    Follow [Dev Leader](https://www.devleader.ca) for articles about Narnia, Copilot CLI session management, and .NET/C# development.",
        "",
    ]
...
def main():
    ...
    print(f'Fetching articles from {_TAG_URL}...')

    try:
        articles = fetch_articles(_TAG_URL)
